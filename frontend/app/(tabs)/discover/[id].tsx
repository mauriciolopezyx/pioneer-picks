      ...
      <SafeAreaView className="flex-1 dark:bg-gray-800" edges={['left', 'right']} >
        ...
        >
          ...
          {loading ? <ActivityIndicator size="large" color="#fff" className="mt-10 self-center" /> : (
            <>
              <Text className="font-montserrat-extrabold text-3xl mb-4 dark:text-white">{data.name}</Text>
              <TouchableOpacity className="mb-8" onPress={() => {openExternalLink(data.description)}}>
